...
- Name: parts/part-detail-tabs.spec.ts >> Part detail tabs — rendering >> DV-011: Test Templates tab is visible and renders for a Trackable part
- Location: tests/parts/part-detail-tabs.spec.ts:190:7

# Error details

```
Error: Tab "Test Templates" should be present in the tab bar

expect(locator).toBeVisible() failed

Locator: getByRole('tab', { name: /Test Templates/i })
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Tab "Test Templates" should be present in the tab bar with timeout 5000ms
  - waiting for getByRole('tab', { name: /Test Templates/i })
