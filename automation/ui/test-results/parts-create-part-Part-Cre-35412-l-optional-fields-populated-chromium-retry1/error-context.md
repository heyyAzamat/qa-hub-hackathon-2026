...
- Name: parts/create-part.spec.ts >> Part Creation — positive paths >> PC-002: create a part with all optional fields populated
- Location: tests/parts/create-part.spec.ts:97:7
