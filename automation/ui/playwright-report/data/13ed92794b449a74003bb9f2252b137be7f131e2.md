...
```
Error: Part "Hierarchy_Part_1776170530537" should appear in the category parts list

expect(locator).toBeVisible() failed

Locator: getByRole('cell', { name: 'Hierarchy_Part_1776170530537' }).first()
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Part "Hierarchy_Part_1776170530537" should appear in the category parts list with timeout 10000ms
  - waiting for getByRole('cell', { name: 'Hierarchy_Part_1776170530537' }).first()
