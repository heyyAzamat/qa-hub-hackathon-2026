...
- Name: parts/create-part.spec.ts >> Part Creation — negative paths >> PC-004: submitting with an empty Name shows a validation error
- Location: tests/parts/create-part.spec.ts:150:7
