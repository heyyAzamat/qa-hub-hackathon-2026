...
```
Error: Category page heading should be "CAT002_Original_1776170336146"

expect(locator).toBeVisible() failed

Locator: getByRole('heading', { name: 'CAT002_Original_1776170336146' }).first()
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Category page heading should be "CAT002_Original_1776170336146" with timeout 10000ms
  - waiting for getByRole('heading', { name: 'CAT002_Original_1776170336146' }).first()
