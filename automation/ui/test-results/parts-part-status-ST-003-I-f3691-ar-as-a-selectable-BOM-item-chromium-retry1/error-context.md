...
- Name: parts/part-status.spec.ts >> ST-003: Inactive part does not appear as a selectable BOM item
- Location: tests/parts/part-status.spec.ts:81:5
...
Call log:
  - waiting for getByRole('tab', { name: /BOM/i }) to be visible
