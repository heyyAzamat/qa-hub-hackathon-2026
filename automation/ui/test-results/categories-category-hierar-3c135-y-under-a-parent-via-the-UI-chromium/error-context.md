...
- Name: categories/category-hierarchy.spec.ts >> CAT-002h: create a child category under a parent via the UI
- Location: tests/categories/category-hierarchy.spec.ts:63:5
...
Call log:
  - waiting for getByRole('button', { name: /new category|add category/i })
