...
- Name: parts/part-detail-tabs.spec.ts >> Part detail tabs — rendering >> DV-004: Allocated tab is clickable and renders
- Location: tests/parts/part-detail-tabs.spec.ts:111:7
...
Call log:
  - waiting for getByRole('tab', { name: /Allocated/i }) to be visible
