...
- Name: categories/category-crud.spec.ts >> CAT-005: deleting a category that contains parts shows a warning
- Location: tests/categories/category-crud.spec.ts:152:5
...
Call log:
  - waiting for getByRole('button', { name: /delete category|delete/i }).first()
