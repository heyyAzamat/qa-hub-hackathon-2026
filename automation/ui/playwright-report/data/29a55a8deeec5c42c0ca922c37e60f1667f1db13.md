...
- Name: parts/create-part.spec.ts >> Part Creation — positive paths >> PC-001: create a part with required fields only
- Location: tests/parts/create-part.spec.ts:75:7
