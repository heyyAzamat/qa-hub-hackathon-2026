...
- Name: parts/create-part.spec.ts >> Part Creation — positive paths >> PC-003: part created via UI appears in the parts list
- Location: tests/parts/create-part.spec.ts:136:7
